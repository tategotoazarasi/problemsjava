...
class SolutionTest {
    ...
    void longestPalindrome() {
        ...
        assertEquals(22, sol.longestPalindrome(new String[]{"dd", "aa", "bb", "dd", "aa", "dd", "bb", "dd", "aa", "cc", "bb", "cc", "dd", "cc"}));
        assertEquals(30, sol.longestPalindrome(new String[]{"mm", "mm", "yb", "by", "bb", "bm", "ym", "mb", "yb", "by", "mb", "mb", "bb", "yb", "by", "bb", "yb", "my", "mb", "ym"}));
    }
}